...
username=$(whoami)
echo "[+]$username can now restart exium-client without password - Success "
...
echo "[+]Installing Slack dependencies for slackbot"
pip install slack
...
#sed -i 's/API_TOKEN_HERE/SLACK-API-TOKEN/' /home/$username/slack-bot/slackbot
